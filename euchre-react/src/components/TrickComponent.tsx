  ...
  return (
    <div className="trick">
        <div className="player-1-card">
            <CardComponent key={1} card={{faceValue:"10", suit:"spades", faceUp: true}} flippedUp={true}/>
        </div>
        <div className="player-2-card">
            <CardComponent key={2} card={{faceValue:"10", suit:"spades", faceUp: true}} flippedUp={true}/>
        </div>
        ...
        <div className="player-4-card">
            <CardComponent key={4} card={{faceValue:"10", suit:"spades", faceUp: true}} flippedUp={true}/>
        </div>
    </div>
  )
}
